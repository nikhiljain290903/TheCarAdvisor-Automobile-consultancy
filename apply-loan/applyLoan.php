...
if (isset($_POST['submit'])) {
    ...
    if (mysqli_num_rows($verify_query) != 0) {
        ...
        mysqli_query($con, "INSERT INTO applyloan(Name,VehicleNo,Model,VehicleName,LoanAmt,IntRate,Tenure,DateAgree,IntAmt,DueAmt) VALUES('$name','$vno','$model','$vname','$loanamt','$intrate','$tenure','$dateagree','$intamt','$dueamt')") or die("Error Occurred");
