...
<script>
function signIn() {
  alert("Please SignIn to the page before applying the Loan.");
}
</script>
<head>
    <title>Loan</title>
...
<hr class="line">
    <div class="main2"><h2>Our services</h2>
        <div class="p3"><br><br>
        ...
        <div class="themain">
        <div class="main3">
            <h3>Easy vehicle loan approval</h3><br>Get quick and hassle-free approval for your vehicle loan with our streamlined application process and attractive low interest rates. <br><br></div>
        <div class="main3"><h3> Flexible Repayment Options</h3><br>Choose from a variety of repayment options that  suit your financial situation and make paying  back your vehicle loan convenient and stress-free. <br><br>
            </div>
        <div class="main3"><h3>Expert Financial Guidance</h3><br>Receive personalized advice and expert guidance from our team of financial professionals to help you make informed decisions regarding your vehicle finance. <br><br>
        <br></div></div>
